...
namespace Riverside.Cms.Core.Assets
{
    public interface IAssetService
    {
        ...
        void Deploy(long tenantId, IUnitOfWork unitOfWork = null);
        string GetAssetStyleSheetPath(long tenantId);
        string GetElementViewPath(long TenantId);
        ...
        HashSet<Guid> GetAssetElementTypes(long tenantId, IUnitOfWork unitOfWork = null);
    }
}
