...
{
    /// <summary>
    /// Deals with display and submission of the confirm (activate) user set password form.
    /// </summary>
    public class ConfirmUserSetPasswordFormService : IFormService
    {
        // Member variables
        ...
        /// </summary>
        public Guid FormId { get { return new Guid("b0f40f31-1f06-4b89-ba48-9e31215555bd"); } }
